...
class User extends Backend {
	...
	function login()
	{
		...
		{ //check to see if the user is logging in
			...
			{ //if the login was un-successful
				...
				redirect('admin/user/login', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->view = 'admin/user/deactivate_user';
		}
		else
		{
